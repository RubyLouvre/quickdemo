...
function cloneElement(element, config) {
  ...
  for (
    var _len2 = arguments.length, children = Array(_len2 > 2 ? _len2 - 2 : 0), _key2 = 2;
    _key2 < _len2;
    _key2++
  ) {
...
function getComponentKey(component, index) {
  if (
    (typeof component === 'undefined' ? 'undefined' : _typeof(component)) === 'object' &&
    component !== null &&
    component.key != null
  ) {
...
function isReferenceType(val) {
  return (
    val &&
    ((typeof val === 'undefined' ? 'undefined' : _typeof$1(val)) === 'object' ||
